...
int fth_runprogram(const char *fname)
   Загрузить области кода и данных из файла с указанным именем и запустить на исполнение с сохранённой точки входа. Для этой функции текстовый интерпретатор может отсутствовать. Возвращает флаг успешного завершения.
